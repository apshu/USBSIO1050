...
#define COMMAND_IN          /*TOTO:define pin*/ PORTCbits.RC4
#define COMMAND_OUT         /*TOTO:define pin*/ do { #error "COMMAND pin is input only!" } while(0)
#define COMMAND_TRIS        /*TOTO:define pin*/ TRISCbits.TRISC4
#define MOTOR_IN            /*TOTO:define pin*/ PORTCbits.RC4
#define MOTOR_OUT           /*TOTO:define pin*/ do { #error "MOTOR pin is input only!" } while(0)
#define MOTOR_TRIS          /*TOTO:define pin*/ TRISCbits.TRISC4
...
#define UART_INVERTED       1
#define UART_DTS            COMMAND_IN
#define USB_CDC_DSR_ACTIVE_LEVEL 1
#define mInitDTSPin()       do { } while (0)
